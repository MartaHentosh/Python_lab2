...
if __name__ == "__main__":
    ...
    fridgeManager.add_fridge(FridgeCamera("InvalidBrand", "Model123", 384, 2, "electric", 2.5, 500))
    ...
    def check_capacity(fridge):
        """
        Checks if fridge has a capacity more than 100
        """
        return fridge.capacity > 100


    condition_result = fridgeManager.check_condition(check_capacity)
